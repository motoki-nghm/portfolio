...
const paths = {
  ...
  img: {
    ...
    distWebp: './public/assets/img/webp/',
  },
  fonts: {
...
function cleanImg(done) {
  src(paths.clean.img, { read: false }).pipe(clean());
  done();
}
// public 内の fonts を削除
...
exports.cleanImg = series(cleanImg);
exports.cleanFonts = series(cleanFonts);
